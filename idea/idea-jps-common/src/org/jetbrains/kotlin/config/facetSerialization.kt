...
private fun readV2AndLaterConfig(element: Element): KotlinFacetSettings {
    return KotlinFacetSettings().apply {
        ...
        readElementsList(element, "externalSystemTestTasks", "externalSystemTestTasks")?.let {
...
private fun saveElementsList(element: Element, moduleList: List<String>, rootElementName: String, elementName: String) {
