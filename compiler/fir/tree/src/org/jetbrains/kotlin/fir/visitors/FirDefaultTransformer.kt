...
abstract class FirDefaultTransformer<D> : FirTransformer<D>() {
    override fun transformDelegatedTypeRef(delegatedTypeRef: FirDelegatedTypeRef, data: D): FirTypeRef {
    ...
    override fun transformResolvedFunctionTypeRef(resolvedFunctionTypeRef: FirResolvedFunctionTypeRef, data: D): FirTypeRef {
    ...
    override fun transformEnumEntry(enumEntry: FirEnumEntry, data: D): FirStatement {
    ...
    override fun transformSealedClass(sealedClass: FirSealedClass, data: D): FirStatement {
