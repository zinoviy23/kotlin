...
import org.jetbrains.kotlin.backend.common.lower.throwUninitializedPropertyAccessException
        ...
        irBuilder.run {
            return irBlock(expression) {
                ...
                +irIfThenElse(
                    ...
                    throwUninitializedPropertyAccessException(backendContext, field.name.asString()),
