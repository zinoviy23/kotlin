...
public class KotlinTestUtils {
    ...
    public static void runTest(@NotNull TestCase testCase, @NotNull Function0 test) throws Exception {
        MuteWithAnnotationKt.testWithMuteAnnotation(test, testCase).invoke();
    }
